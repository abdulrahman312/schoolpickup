...
export const TeacherView: React.FC<TeacherViewProps> = ({ onLogout }) => {
  ...
  const isBusStudent = (student: Student) => {
    return student.bus_status && student.bus_status.toUpperCase() !== 'NO' && student.bus_status.toUpperCase() !== 'OUTSIDE BUS';
  };

  const isOutsideBus = (student: Student) => {
    return student.bus_status && student.bus_status.toUpperCase() === 'OUTSIDE BUS';
  };
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-3 pb-20">
              {filteredStudents.map((student) => {
                ...
                const isOutside = isOutsideBus(student);
                ...
                if (active) {
                  ...
                  cardStyle = 'bg-gradient-to-br from-yellow-400 to-amber-500 border-transparent text-white shadow-lg shadow-yellow-500/30';
                } else if (isBus) {
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className={`text-sm font-bold leading-tight break-words w-full ${active || isBus || isOutside ? 'text-white' : 'text-gray-900'}`}>
                    ...
                    <div className="mt-auto pt-2 flex items-center justify-between">
                      <div className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider ${
                        ...
                        {active ? 'Waiting' : isOutside ? 'Outside Bus' : isBus ? 'Bus Student' : 'In Class'}
                      </div>
